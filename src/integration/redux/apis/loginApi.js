    ...
    endpoints: (builder) => ({
        ...
        logOut: builder.mutation({
            query: (payload) => ({
                ...
                method: "post",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem(variables.accessToken)}`,
                },
            }),
        }),
...
export const { useLoginMutation, useLogOutMutation, useSendOtpMutation, useVerifyOtpMutation, useChangePasswordMutation, } = loginApi;
